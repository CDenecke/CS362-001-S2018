   ...
   /**
	...
	//			System.out.println(" Seed:"+randomseed );
				Random random = new Random(randomseed);
				 ...
				 int startDay=ValuesGenerator.getRandomIntBetween(random, -31, 62);
					...
					String methodName = ApptRandomTest.RandomSelectMethod(random);
					   ...
					   if (methodName.equals("setTitle")){
						   ...
						   appt.setRecurrence(recurDays, recur, recurIncrement, recurNumber);
							...
							int day=ValuesGenerator.getRandomIntBetween(random, -31, 62);
				 			int month=ValuesGenerator.getRandomIntBetween(random, -12, 24);
							int year=ValuesGenerator.getRandomIntBetween(random, -1, 1); //fails no matter what
